...
function NewQuotation({ open, onClose }) {
  ...
  const footer = (<div className="footer-actions w-full bg-white py-3">
    <button
    ...
    <Modal open={open} onClose={onClose} title="New Quotation" footer={footer} width={720}>
      ...
      <div className="" style={{ alignItems: 'start' }}>
        <div>
          ...
          <label className="field"><div className="field-label">Linked Project</div>
            <MultiSelect options={projects} value={selProjects} onChange={setSelProjects} placeholder="Select Project" />
          </label>
          <label className="field"><div className="field-label">Items</div>
            <MultiSelect options={items} value={selItems} onChange={setSelItems} placeholder="Select Items" />
          </label>
          <label className="field">
            <div className="field-label">Items Number</div>
            <MultiSelect options={itemNumbers} value={selNumbers} onChange={setSelNumbers} placeholder="Enter Items Number" />
          </label>

          <label className="field">
            <div className="field-label">Total Value</div>
            <input className="input" placeholder="Enter Total Value" />
          </label>
          <label className="field">
            <div className="field-label">Delivery ETA</div>
            <input className="input" placeholder="Select Date" type='date' />
          </label>
        </div>
